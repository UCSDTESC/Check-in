        ...
        <div className="row flex-row">
          <div className="col px-0">
            <input className="form-control" placeholder="Your Question Here..."
              value={question} type="textbox"
              onChange={e => this.setState({question: e.target.value})}/>
          </div>
          <div className={`col-auto ml-auto flex-column
            custom-question__checkbox d-flex align-items-center
            justify-content-center`}>
              Required
            <ToggleSwitch checked={isRequired}
