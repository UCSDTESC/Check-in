...
export const sendRejectionEmail = (toUser: TESCUser, event: TESCEvent) => {
...
export const sendWaitlistEmail = (toUser: TESCUser, event: TESCEvent) => {
